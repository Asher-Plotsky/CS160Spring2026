package Project7.CustomLinkedList;
/*
Program 7 Is List Sorted
...
public class CustomLinkedList {
    ...
    public static boolean isSorted(IntNode headObj) {
        /* Type your code here */
        if (headObj == null || headObj.getNext() == null) {
            return true;
        }
        if (headObj.getNext().getNodeData() < headObj.getNodeData()){
            return false;
        }
        else{
            return isSorted(headObj.getNext());
        }
    }
