...
// write your switch statement here
            switch(input){
                ...
                case 'H' :
                    ...
                    break;
                case 'w' :
                    racerList.add(new Warper("Warper", START_LINE, yPos));
                    yPos += RACER_SPACE;
                    break;
                case 'W' :
                    racerList.add(new Warper("Warper", START_LINE, yPos));
                    ...
                    break;
                case 'c' :
                    racerList.add(new Cannon("Cannon", START_LINE, yPos));
                    yPos += RACER_SPACE;
                    break;
                case 'C' :
                    racerList.add(new Cannon("Cannon", START_LINE, yPos));
                    ...
                    break;
                default :
                    JOptionPane.showMessageDialog( this, "Input not recognised" );
            }
...
// slow down here if you know how
    ...
    private char getRacer() {
        String input = JOptionPane.showInputDialog(this, "Enter a racer:"
                        + "\nt for Tortoise, h for hare, c for Cannon, w for Warper" + "\nor s to start the race");
        if (input == null) {
