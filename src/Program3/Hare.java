...
// tail
        g.setColor( Color.LIGHT_GRAY );
        g.fillOval( startX - 37, startY + 28, 12, 12 ) ;
//body
        g.setColor( Color.GRAY );
        g.fillOval( startX - 30, startY + 20, 20, 20 );
//head
        g.fillOval( startX - 13, startY + 22, 13, 8 );
        g.fillOval( startX - 13, startY + 12, 8, 28 );
//flatten bottom
        g.clearRect( startX - 37, startY + 35, 32, 5 );
    }
}